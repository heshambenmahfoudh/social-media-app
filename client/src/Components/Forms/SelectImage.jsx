...
export default function SelectImage ({chaneValue ,name,
  setImageUrl, imgUrl,loadingImage}) {
  return (
      <div className="w-full gap-2 ">
           {imgUrl ? (
              ...
              rounded-lg px-1 py-2.5 text-center  text-red-50 
                  inline-flex items-center "
            >
              <svg
                aria-hidden="true"
                role="status"
                className="inline w-5 h-5 mr-1 text-gray-600 animate-spin"
                viewBox="0 0 100 101"
                fill="none"
            ...
            <h2 className="text-19">{loadingImage?'Uploading...':'Upload'}</h2>
                </label>
)}
          </div>
  )
